...
<html lang="en">
  <head>
    ...
    <title>Arsip Surat Bapenda Provinsi Kalimantan Barat</title>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="proses_login.php" id="login" name="login" method="post">
              ...
              <div class="separator">
                <div>
                  <h2><i class="fa fa-institution"></i>BAPENDA PROVINSI KALIMANTAN BARAT</h2>
                  <p>©2025 POLITEKNIK NEGERI PONTIANAK</p>
                </div>
              </div>
            </form>
          </section>
