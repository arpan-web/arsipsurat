<?php
	...
	if ($jumlah == 0) {
		$nomorurut_suratmasuk = "0001";
	} else {
		$nomormax = substr($data['nomorurut_suratmasuk'], 0, 4);
		$nomorurut_suratmasuk = str_pad(intval($nomormax) + 1, 4, "0", STR_PAD_LEFT);
	}
    ...
    if (!($tgl_masuk=='') and !($kode_suratmasuk =='') and !($nomor_suratmasuk =='') and !($tgl_surat =='') and !($pengirim =='')  and !($kepada_suratmasuk =='') and !($perihal_suratmasuk =='') and !($operator =='') and !($tanggal_entry =='') and !($disposisi1 =='') and !($tgl_disp1 =='') and !($disposisi3 =='') and !($tgl_disp3 =='') and   
