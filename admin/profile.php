                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <?php 
                          $imagePath = "images/" . $data['gambar'];
                          if (!empty($data['gambar']) && file_exists($imagePath)) { 
                            $displayImage = $imagePath;
                          } else { 
                            $displayImage = "images/default-profile.png"; // Ganti dengan nama file ikon profil default Anda
                          }
                          ?>
                          <img class="img-responsive avatar-view" src="<?php echo $displayImage; ?>" alt="Avatar" title="Change the avatar">
                        </div>
                      </div>
