        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">Bapenda </span></a>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di Bapenda Provinsi Kalimantan Barat</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              ...
              <figcaption>
                  <h2>RIFKI</h2>
                  <p>"BAPENDA PROV. KALIMANTAN BARAT"</p>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; BAPENDA PROV. KALIMANTAN BARAT. All Rights Reserved.</p>
          <div class="credits">
            <!-- 
